...
/**
 * iPhone 17 Pro device mockup (Eldora UI, `@eldoraui/iphone-17-pro`).
 * The screenshot rides inside the SVG, clipped to the rounded screen, with the
 * pill notch drawn on top like the real device. Tweaked from upstream to
 * top-align the screenshot (`xMidYMin`) since app screens are tall.
 */
