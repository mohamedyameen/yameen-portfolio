...
(function () {
  ...
  const TICKETS = TICKET_SEED.map((t, i) => {
    ...
    return {
      ...
      ruleExecuted: true,
      skillsRequired: category === 'HVAC' ? ['HVAC', 'Controls'] : [],
      source: 'ticket',
    };
  });
  ...
  const DISPATCH_SEED = {
    ...
    0: {
      policiesApplied: [{ id: 1, policyId: 62, policyName: 'HVAC — contracted vendor' }],
    ...
    9: {
      ...
      policyFlow: {
        ...
        policyMatched: 'Life safety was evaluated and ruled out: it covers entrapment, and there is no person trapped here. Ranked on the default weighting.',
  ...
  const INTAKE_CONFIG = {
    ...
    voices: [
      { name: 'DEEPGRAM_FEMALE_EN_UK_AMELIA',                 displayName: 'Amelia',      gender: 'female', 
        language: 'en-uk',     provider: 'DEEPGRAM',    voiceId: 'amelia',      description: 'British English · warm' },
      { name: 'DEEPGRAM_FEMALE_EN_UK_BEATRICE',                 displayName: 'Beatrice',    gender: 'female', 
        language: 'en-uk',     provider: 'DEEPGRAM',    voiceId: 'beatrice',    description: 'British English · measured' },
      { name: 'DEEPGRAM_FEMALE_EN_UK_IMOGEN',                 displayName: 'Imogen',      gender: 'female', 
        language: 'en-uk',     provider: 'DEEPGRAM',    voiceId: 'imogen',      description: 'British English · bright' },
      { name: 'DEEPGRAM_MALE_EN_UK_CALLUM',                   displayName: 'Callum',      gender: 'male',   
        language: 'en-uk',     provider: 'DEEPGRAM',    voiceId: 'callum',      description: 'British English · calm' },
      { name: 'DEEPGRAM_MALE_EN_UK_RUPERT',                   displayName: 'Rupert',      gender: 'male',   
        language: 'en-uk',     provider: 'DEEPGRAM',    voiceId: 'rupert',      description: 'British English · formal' },
      { name: 'DEEPGRAM_MALE_EN_UK_IDRIS',                   displayName: 'Idris',       gender: 'male',   
        language: 'en-uk',     provider: 'DEEPGRAM',    voiceId: 'idris',       description: 'British English · warm' },
      { name: 'DEEPGRAM_FEMALE_EN_US_NORA',                 displayName: 'Nora',        gender: 'female', 
        language: 'en-us',     provider: 'DEEPGRAM',    voiceId: 'nora',        description: 'American English · bright' },
      { name: 'DEEPGRAM_FEMALE_EN_US_HARPER',                 displayName: 'Harper',      gender: 'female', 
        language: 'en-us',     provider: 'DEEPGRAM',    voiceId: 'harper',      description: 'American English · friendly' },
      { name: 'DEEPGRAM_FEMALE_EN_US_SLOANE',                 displayName: 'Sloane',      gender: 'female', 
        language: 'en-us',     provider: 'DEEPGRAM',    voiceId: 'sloane',      description: 'American English · crisp' },
      { name: 'DEEPGRAM_MALE_EN_US_MILES',                   displayName: 'Miles',       gender: 'male',   
        language: 'en-us',     provider: 'DEEPGRAM',    voiceId: 'miles',       description: 'American English · confident' },
      { name: 'DEEPGRAM_MALE_EN_US_BENNETT',                   displayName: 'Bennett',     gender: 'male',   
        language: 'en-us',     provider: 'DEEPGRAM',    voiceId: 'bennett',     description: 'American English · calm' },
      { name: 'DEEPGRAM_MALE_EN_US_COLE',                   displayName: 'Cole',        gender: 'male',   
        language: 'en-us',     provider: 'DEEPGRAM',    voiceId: 'cole',        description: 'American English · upbeat' },
      { name: 'DEEPGRAM_FEMALE_EN_AU_MATILDA',                 displayName: 'Matilda',     gender: 'female', 
        language: 'en-au',     provider: 'DEEPGRAM',    voiceId: 'matilda',     description: 'Australian English · relaxed' },
      { name: 'DEEPGRAM_FEMALE_EN_AU_SIENNA',                 displayName: 'Sienna',      gender: 'female', 
        language: 'en-au',     provider: 'DEEPGRAM',    voiceId: 'sienna',      description: 'Australian English · warm' },
      { name: 'DEEPGRAM_FEMALE_EN_AU_FREYA',                 displayName: 'Freya',       gender: 'female', 
        language: 'en-au',     provider: 'DEEPGRAM',    voiceId: 'freya',       description: 'Australian English · clear' },
      { name: 'DEEPGRAM_MALE_EN_AU_ANGUS',                   displayName: 'Angus',       gender: 'male',   
        language: 'en-au',     provider: 'DEEPGRAM',    voiceId: 'angus',       description: 'Australian English · easy-going' },
      { name: 'DEEPGRAM_MALE_EN_AU_BLAKE',                   displayName: 'Blake',       gender: 'male',   
        language: 'en-au',     provider: 'DEEPGRAM',    voiceId: 'blake',       description: 'Australian English · steady' },
      { name: 'DEEPGRAM_MALE_EN_AU_JARRAH',                   displayName: 'Jarrah',      gender: 'male',   
        language: 'en-au',     provider: 'DEEPGRAM',    voiceId: 'jarrah',      description: 'Australian English · friendly' },
      { name: 'ELEVENLABS_FEMALE_EN_AE_LAYLA',               displayName: 'Layla',       gender: 'female', 
        language: 'en-ae',     provider: 'ELEVENLABS',  voiceId: 'layla',       description: 'English (UAE) · warm' },
      { name: 'ELEVENLABS_FEMALE_EN_AE_NOOR',               displayName: 'Noor',        gender: 'female', 
        language: 'en-ae',     provider: 'ELEVENLABS',  voiceId: 'noor',        description: 'English (UAE) · clear' },
      { name: 'ELEVENLABS_FEMALE_EN_AE_MARIAM',               displayName: 'Mariam',      gender: 'female', 
        language: 'en-ae',     provider: 'ELEVENLABS',  voiceId: 'mariam',      description: 'English (UAE) · measured' },
      { name: 'ELEVENLABS_MALE_EN_AE_OMAR',                 displayName: 'Omar',        gender: 'male',   
        language: 'en-ae',     provider: 'ELEVENLABS',  voiceId: 'omar',        description: 'English (UAE) · calm' },
      { name: 'ELEVENLABS_MALE_EN_AE_RASHID',                 displayName: 'Rashid',      gender: 'male',   
        language: 'en-ae',     provider: 'ELEVENLABS',  voiceId: 'rashid',      description: 'English (UAE) · confident' },
      { name: 'ELEVENLABS_MALE_EN_AE_ZAYD',                 displayName: 'Zayd',        gender: 'male',   
        language: 'en-ae',     provider: 'ELEVENLABS',  voiceId: 'zayd',        description: 'English (UAE) · friendly' },
      { name: 'ELEVENLABS_FEMALE_EN_AR_AE_SALMA',            displayName: 'Salma',       gender: 'female', 
        language: 'en-ar-ae',  provider: 'ELEVENLABS',  voiceId: 'salma',       description: 'English & Arabic (UAE) · bilingual, warm' },
      { name: 'ELEVENLABS_FEMALE_EN_AR_AE_DANA',            displayName: 'Dana',        gender: 'female', 
        language: 'en-ar-ae',  provider: 'ELEVENLABS',  voiceId: 'dana',        description: 'English & Arabic (UAE) · bilingual, clear' },
      { name: 'ELEVENLABS_FEMALE_EN_AR_AE_HESSA',            displayName: 'Hessa',       gender: 'female', 
        language: 'en-ar-ae',  provider: 'ELEVENLABS',  voiceId: 'hessa',       description: 'English & Arabic (UAE) · bilingual, calm' },
      { name: 'ELEVENLABS_MALE_EN_AR_AE_TARIQ',              displayName: 'Tariq',       gender: 'male',   
        language: 'en-ar-ae',  provider: 'ELEVENLABS',  voiceId: 'tariq',       description: 'English & Arabic (UAE) · bilingual, measured' },
      { name: 'ELEVENLABS_MALE_EN_AR_AE_FAISAL',              displayName: 'Faisal',      gender: 'male',   
        language: 'en-ar-ae',  provider: 'ELEVENLABS',  voiceId: 'faisal',      description: 'English & Arabic (UAE) · bilingual, confident' },
      { name: 'ELEVENLABS_MALE_EN_AR_AE_KHALID',              displayName: 'Khalid',      gender: 'male',   
        language: 'en-ar-ae',  provider: 'ELEVENLABS',  voiceId: 'khalid',      description: 'English & Arabic (UAE) · bilingual, warm' },
      { name: 'ELEVENLABS_FEMALE_AR_EG_NADIA',               displayName: 'Nadia',       gender: 'female', 
        language: 'ar-eg',     provider: 'ELEVENLABS',  voiceId: 'nadia',       description: 'Egyptian Arabic · warm' },
      { name: 'ELEVENLABS_FEMALE_AR_EG_YASMIN',               displayName: 'Yasmin',      gender: 'female', 
        language: 'ar-eg',     provider: 'ELEVENLABS',  voiceId: 'yasmin',      description: 'Egyptian Arabic · bright' },
      { name: 'ELEVENLABS_FEMALE_AR_EG_FARIDA',               displayName: 'Farida',      gender: 'female', 
        language: 'ar-eg',     provider: 'ELEVENLABS',  voiceId: 'farida',      description: 'Egyptian Arabic · calm' },
      { name: 'ELEVENLABS_MALE_AR_EG_KARIM',                 displayName: 'Karim',       gender: 'male',   
        language: 'ar-eg',     provider: 'ELEVENLABS',  voiceId: 'karim',       description: 'Egyptian Arabic · friendly' },
      { name: 'ELEVENLABS_MALE_AR_EG_HOSSAM',                 displayName: 'Hossam',      gender: 'male',   
        language: 'ar-eg',     provider: 'ELEVENLABS',  voiceId: 'hossam',      description: 'Egyptian Arabic · measured' },
      { name: 'ELEVENLABS_MALE_AR_EG_SHERIF',                 displayName: 'Sherif',      gender: 'male',   
        language: 'ar-eg',     provider: 'ELEVENLABS',  voiceId: 'sherif',      description: 'Egyptian Arabic · confident' },
      { name: 'ELEVENLABS_FEMALE_AR_AE_ALIA',               displayName: 'Alia',        gender: 'female', 
        language: 'ar-ae',     provider: 'ELEVENLABS',  voiceId: 'alia',        description: 'Emirati Arabic · warm' },
      { name: 'ELEVENLABS_FEMALE_AR_AE_SHAMMA',               displayName: 'Shamma',      gender: 'female', 
        language: 'ar-ae',     provider: 'ELEVENLABS',  voiceId: 'shamma',      description: 'Emirati Arabic · clear' },
      { name: 'ELEVENLABS_FEMALE_AR_AE_MAITHA',               displayName: 'Maitha',      gender: 'female', 
        language: 'ar-ae',     provider: 'ELEVENLABS',  voiceId: 'maitha',      description: 'Emirati Arabic · gentle' },
      { name: 'ELEVENLABS_MALE_AR_AE_SAEED',                 displayName: 'Saeed',       gender: 'male',   
        language: 'ar-ae',     provider: 'ELEVENLABS',  voiceId: 'saeed',       description: 'Emirati Arabic · calm' },
      { name: 'ELEVENLABS_MALE_AR_AE_HAMDAN',                 displayName: 'Hamdan',      gender: 'male',   
        language: 'ar-ae',     provider: 'ELEVENLABS',  voiceId: 'hamdan',      description: 'Emirati Arabic · formal' },
      { name: 'ELEVENLABS_MALE_AR_AE_MAJID',                 displayName: 'Majid',       gender: 'male',   
        language: 'ar-ae',     provider: 'ELEVENLABS',  voiceId: 'majid',       description: 'Emirati Arabic · friendly' },
      { name: 'ELEVENLABS_FEMALE_AR_SA_REEM',               displayName: 'Reem',        gender: 'female', 
        language: 'ar-sa',     provider: 'ELEVENLABS',  voiceId: 'reem',        description: 'Saudi Arabic · measured' },
      { name: 'ELEVENLABS_FEMALE_AR_SA_LAMIA',               displayName: 'Lamia',       gender: 'female', 
        language: 'ar-sa',     provider: 'ELEVENLABS',  voiceId: 'lamia',       description: 'Saudi Arabic · warm' },
      { name: 'ELEVENLABS_FEMALE_AR_SA_JAWAHER',               displayName: 'Jawaher',     gender: 'female', 
        language: 'ar-sa',     provider: 'ELEVENLABS',  voiceId: 'jawaher',     description: 'Saudi Arabic · clear' },
      { name: 'ELEVENLABS_MALE_AR_SA_ABDULLAH',                 displayName: 'Abdullah',    gender: 'male',   
        language: 'ar-sa',     provider: 'ELEVENLABS',  voiceId: 'abdullah',    description: 'Saudi Arabic · formal' },
      { name: 'ELEVENLABS_MALE_AR_SA_TURKI',                 displayName: 'Turki',       gender: 'male',   
        language: 'ar-sa',     provider: 'ELEVENLABS',  voiceId: 'turki',       description: 'Saudi Arabic · calm' },
      { name: 'ELEVENLABS_MALE_AR_SA_BANDAR',                 displayName: 'Bandar',      gender: 'male',   
        language: 'ar-sa',     provider: 'ELEVENLABS',  voiceId: 'bandar',      description: 'Saudi Arabic · confident' },
      { name: 'ELEVENLABS_FEMALE_HI_IN_ADITI',               displayName: 'Aditi',       gender: 'female', 
        language: 'hi-in',     provider: 'ELEVENLABS',  voiceId: 'aditi',       description: 'Hindi · warm' },
      { name: 'ELEVENLABS_FEMALE_HI_IN_KAVYA',               displayName: 'Kavya',       gender: 'female', 
        language: 'hi-in',     provider: 'ELEVENLABS',  voiceId: 'kavya',       description: 'Hindi · bright' },
      { name: 'ELEVENLABS_FEMALE_HI_IN_MEERA',               displayName: 'Meera',       gender: 'female', 
        language: 'hi-in',     provider: 'ELEVENLABS',  voiceId: 'meera',       description: 'Hindi · calm' },
      { name: 'ELEVENLABS_MALE_HI_IN_ROHAN',                 displayName: 'Rohan',       gender: 'male',   
        language: 'hi-in',     provider: 'ELEVENLABS',  voiceId: 'rohan',       description: 'Hindi · friendly' },
      { name: 'ELEVENLABS_MALE_HI_IN_ARJUN',                 displayName: 'Arjun',       gender: 'male',   
        language: 'hi-in',     provider: 'ELEVENLABS',  voiceId: 'arjun',       description: 'Hindi · measured' },
      { name: 'ELEVENLABS_MALE_HI_IN_VIKRAM',                 displayName: 'Vikram',      gender: 'male',   
        language: 'hi-in',     provider: 'ELEVENLABS',  voiceId: 'vikram',      description: 'Hindi · confident' },
      { name: 'ELEVENLABS_FEMALE_TA_IN_ANITHA',               displayName: 'Anitha',      gender: 'female', 
        language: 'ta-in',     provider: 'ELEVENLABS',  voiceId: 'anitha',      description: 'Tamil · warm' },
      { name: 'ELEVENLABS_FEMALE_TA_IN_DIVYA',               displayName: 'Divya',       gender: 'female', 
        language: 'ta-in',     provider: 'ELEVENLABS',  voiceId: 'divya',       description: 'Tamil · clear' },
      { name: 'ELEVENLABS_FEMALE_TA_IN_KALAIVANI',               displayName: 'Kalaivani',   gender: 'female', 
        language: 'ta-in',     provider: 'ELEVENLABS',  voiceId: 'kalaivani',   description: 'Tamil · measured' },
      { name: 'ELEVENLABS_MALE_TA_IN_KARTHIK',                 displayName: 'Karthik',     gender: 'male',   
        language: 'ta-in',     provider: 'ELEVENLABS',  voiceId: 'karthik',     description: 'Tamil · calm' },
      { name: 'ELEVENLABS_MALE_TA_IN_SENTHIL',                 displayName: 'Senthil',     gender: 'male',   
        language: 'ta-in',     provider: 'ELEVENLABS',  voiceId: 'senthil',     description: 'Tamil · friendly' },
      { name: 'ELEVENLABS_MALE_TA_IN_VETRI',                 displayName: 'Vetri',       gender: 'male',   
        language: 'ta-in',     provider: 'ELEVENLABS',  voiceId: 'vetri',       description: 'Tamil · confident' },
    ],
    endConditions: [
